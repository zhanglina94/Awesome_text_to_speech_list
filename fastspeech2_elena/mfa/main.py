...
def run():
  ...
  if "new_voice" in dataset_path.lower():
    instence = new_voice.NewVoiceDataset(dataset_path,preprocessed_file_dir,result_dir,num_jobs=num_jobs,phone_set=None)
	elif "esd" in dataset_path.lower():
