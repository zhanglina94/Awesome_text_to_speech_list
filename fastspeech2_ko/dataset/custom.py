...
class custom_Dataset():
	...
	def job(self, info):
		...
		#temp = line.strip('\n')
		transcript_filename = transcript.split(" ")[0] + ".wav"

		text = transcript.split()[13:]
		print("filename:",filename, "transcript_filename:",transcript_filename,"text:", text)
	...
	def run(self):
		...
		dictionary_path = os.path.join(self.result_dir, "{}_dic.txt".format(self.dataset_name))
